...
import LandingPage from "../public/images/LandingPages/LandignPageMain.png";
        ...
        {projects.map((project, index) => (
          <div key={index} className="flex flex-col lg:flex-row items-center w-full mb-12">
            ...
            <div className="w-full lg:w-1/2 flex justify-center lg:justify-start pl-0 lg:pl-8">
              <div className="relative w-[250px] h-[150px] sm:w-[300px] sm:h-[200px] lg:w-[400px] lg:h-[300px] rounded-md shadow-neon overflow-hidden">
                {/* Conditionally render the Image component if the project has an image */}
                {project.image && (
                  <Image
                    src={project.image}
                    alt={project.title}
